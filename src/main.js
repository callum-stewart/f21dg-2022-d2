...
window.addEventListener("DOMContentLoaded", (event) => {
  ...
  sessionStorage.setItem(
    "settings",
    JSON.stringify(bookmark.paramsToObj(searchParams))
  );
...
// steptip.tooltip(document.getElementById("emd-btn"),"This is first tutorial tooltip!",1,"light");
// steptip.tooltip(document.getElementById("stft-btn"),"This is second and last tutorial tooltip!",2,"dark");
...
//       {
//         element: "#upload-btn",
//         description: "hi this is stft",
//         placement: "bottom",
//       },
//       {
//         element: "#emd-btn",
//         description: "This is the brand name of the App.cdho",
//         placement: "right",
//       },
//       {
//         element: "#upload-btn",
...
//   document
//     .querySelector("#tooltip-helper-next-sequence")
