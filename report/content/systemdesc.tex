...
the time-series, alongside Pandas for series storage. Using these separate functions again introduces modularity, and allows modifying and testing of specific components.
...
STFT analysis is performed on either user uploaded data or tool generated signals depending on choice made in the user interface. 
Either way, the process is the same, where the exposed \verb|FUNCTIONNAMEHERE| function is called, passing in the required input parameters.
